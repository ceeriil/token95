...
>(({ result }, ref) => (
  ...
  >
    ...
    <div className="flex-1 overflow-auto bg-white win95-inset h-full border border-black py-2 px-4 pb-10">
      <div className="flex justify-between">
        ...
        <div>
          <DicebearAvatar seed="dd" size={120} />
        </div>
      </div>
      ...
      <p className="mt-6 text-xs text-gray-500">Generated via Token98</p>
      <img
        src="/img/dd.svg"
        width={100}
