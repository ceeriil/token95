...
export const PLATFORM_SHARABLE_URL = "token98.vercel.app";
...
export const TOKEN_METADATA_FETCHER = (() => {
  if (import.meta.env.VITE_MAINNET_RPC) {
    return makeHeliusTokenFetcher(import.meta.env.VITE_MAINNET_RPC, {
      dollarBaseWager: 1,
    });
  }
})();
